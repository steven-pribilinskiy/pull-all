...
export const keymap: KeymapSection[] = [
  {
    ...
    bindings: [
      ...
      { keys: [','], action: 'Open the settings modal', note: 'General: panel padding · grouping · tree view — Theming: icons (Unicode/emoji) · theme (auto/dark/light) · background (normal/soft) · contrast (normal/soft); background and contrast are independent (background = surface tones, contrast = text/accent saturation); rows and radio chips are clickable, [x]/outside-click closes', keywords: ['settings', 'preferences', 'config', 'emoji', 'padding', 'theme', 'background', 'contrast', 'dark mode', 'light mode', 'grouping', 'tree', 'mouse'] },
  ...
  },
  {
    ...
    bindings: [
      ...
      { keys: ['t'], action: 'Column-toggle menu', note: 'then b/y/a/m/d/c/u/g/s → ahead-behind/dirty/added/modified/deleted/total/upstream/age/subject; clickable chips; empty columns auto-hide and their chip is dim/inert; persisted', keywords: ['columns', 'added', 'modified', 'deleted', 'stats'] },
